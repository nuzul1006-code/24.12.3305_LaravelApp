    ...
    <div class="lg:col-span-1">
        <div class="sticky top-32">
            <img src="{{ asset('assets/concert.png') }}"
                 alt="Concert Poster" class="w-full rounded-[2.5rem] shadow-2xl border-8 border-white">
    ...
    <div class="lg:col-span-2 space-y-12">
        ...
        <div>
            ...
            <p class="text-lg text-slate-600 leading-relaxed mt-4">
                ...
                artis favorit lainnya. Acara ini juga dilengkapi dengan food stall premium dan area networking yang nyaman.
            </p>
        </div>
