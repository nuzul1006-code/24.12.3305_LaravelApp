...
<div class="bg-white rounded-[2.5rem] border border-slate-100 p-10 shadow-sm max-w-4xl">
    <form action="{{ route('admin.events.update', $event->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-2">
                ...
                <textarea name="description" rows="4"
                    class="w-full px-5 py-3 rounded-xl border border-slate-200 outline-none resize-none" required>{{ old('description', $event->description) }}</textarea>
            ...
            <div class="col-span-2">
                ...
                <div class="flex items-start gap-6 p-4 border border-dashed border-slate-200 rounded-2xl bg-slate-50/50">
                    ...
                    <div class="shrink-0 text-center">
                        ...
                        @else
                            <div class="w-24 h-32 rounded-xl bg-slate-200 flex items-center justify-center text-slate-400 text-xs font-bold">
                                No Image
                            </div>
                        @endif
                    </div>
        ...
        <div class="flex justify-end gap-4 mt-10 pt-6 border-t border-slate-100">
            ...
            <button type="submit" class="px-10 py-3 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 active:scale-95 transition">
                Simpan Perubahan
            </button>
        </div>
